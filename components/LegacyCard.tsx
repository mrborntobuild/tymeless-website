...
const LegacyCard: React.FC<LegacyCardProps> = ({ persona, onClick }) => {
  return (
    <div 
      ...
      className="group relative h-[420px] w-full md:w-[340px] flex-shrink-0 rounded-2xl overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-[1.02] shadow-lg"
    >
      {/* Background Image */}
      <img 
